...
module.exports = function() {
  ...
  // Check that resourcesToIgnore is an array
  if (!options.resourcesToIgnore instanceof Array) {
    return cb(new Error('Option resourcesToIgnore  must be an instanceof Array.'));
  }

  options.cookies = JSON.stringify(options.cookies);
  options.resourcesToIgnore = JSON.stringify(options.resourcesToIgnore);
